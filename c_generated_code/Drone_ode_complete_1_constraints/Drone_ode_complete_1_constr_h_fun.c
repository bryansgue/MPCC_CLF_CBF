...
#else
  #define CASADI_PREFIX(ID) Drone_ode_complete_1_constr_h_fun_ ## ID
#endif
...
/* Drone_ode_complete_1_constr_h_fun:(i0[13],i1[4],i2[],i3[20])->(o0[2]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w12;
  /* #272: @19 = @58[:3] */
  for (rr=w19, ss=w58+0; ss!=w58+3; ss+=1) *rr++ = *ss;
  /* #273: @46 = vertcat(@2, @6, @11, @16, @17, @18, @23, @24, @25, @26, @30, @34, @35) */
  rr=w46;
  *rr++ = w2;
  *rr++ = w6;
  *rr++ = w11;
  ...
  *rr++ = w35;
  /* #274: @32 = @46[:3] */
  for (rr=w32, ss=w46+0; ss!=w46+3; ss+=1) *rr++ = *ss;
  /* #275: @19 = (@19-@32) */
  for (i=0, rr=w19, cs=w32; i<3; ++i) (*rr++) -= (*cs++);
  /* #276: @32 = fabs(@19) */
  for (i=0, rr=w32, cs=w19; i<3; ++i) *rr++ = fabs( *cs++ );
  /* #277: @41 = @32' */
  casadi_copy(w32, 3, w41);
  /* #278: @41 = (-@41) */
  for (i=0, rr=w41, cs=w41; i<3; ++i) *rr++ = (- *cs++ );
  /* #279: @19 = sign(@19) */
  for (i=0, rr=w19, cs=w19; i<3; ++i) *rr++ = casadi_sign( *cs++ );
  /* #280: @40 = @46[3:6] */
  for (rr=w40, ss=w46+3; ss!=w46+6; ss+=1) *rr++ = *ss;
  /* #281: @19 = (@19*@40) */
  for (i=0, rr=w19, cs=w40; i<3; ++i) (*rr++) *= (*cs++);
  /* #282: @0 = mac(@41,@19,@0) */
...
CASADI_SYMBOL_EXPORT int Drone_ode_complete_1_constr_h_fun(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int Drone_ode_complete_1_constr_h_fun_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int Drone_ode_complete_1_constr_h_fun_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void Drone_ode_complete_1_constr_h_fun_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int Drone_ode_complete_1_constr_h_fun_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void Drone_ode_complete_1_constr_h_fun_release(int mem) {
}

CASADI_SYMBOL_EXPORT void Drone_ode_complete_1_constr_h_fun_incref(void) {
}

CASADI_SYMBOL_EXPORT void Drone_ode_complete_1_constr_h_fun_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int Drone_ode_complete_1_constr_h_fun_n_in(void) { return 4;}

CASADI_SYMBOL_EXPORT casadi_int Drone_ode_complete_1_constr_h_fun_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real Drone_ode_complete_1_constr_h_fun_default_in(casadi_int i){
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* Drone_ode_complete_1_constr_h_fun_name_in(casadi_int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* Drone_ode_complete_1_constr_h_fun_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* Drone_ode_complete_1_constr_h_fun_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* Drone_ode_complete_1_constr_h_fun_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int Drone_ode_complete_1_constr_h_fun_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 24;
  if (sz_res) *sz_res = 7;
  if (sz_iw) *sz_iw = 5;
  if (sz_w) *sz_w = 169;
